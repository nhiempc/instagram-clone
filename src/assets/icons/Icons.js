...
export const HomeActiveIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Trang chủ'
        color='rgb(38, 38, 38)'
        fill='rgb(38, 38, 38)'
...
export const SearchActiveIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Tìm kiếm'
        className='_ab6-'
        color='rgb(38, 38, 38)'
...
export const ExploreIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Khám phá'
        className='_ab6-'
        color='rgb(38, 38, 38)'
...
export const ExploreActiveIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Khám phá'
        className='_ab6-'
        color='rgb(38, 38, 38)'
...
export const ReelsIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Reels'
        className='_ab6-'
        color='rgb(38, 38, 38)'
...
export const ReelsActiveIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Reels'
        className='_ab6-'
        color='rgb(38, 38, 38)'
...
export const MessengerIcon = ({ width = '24', height = '24' }) => (
    <svg
...
export const MessengerActiveIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Messenger'
        className='_ab6-'
        color='rgb(38, 38, 38)'
...
export const NotificationIcon = ({ width = '24', height = '24' }) => (
    <svg
...
export const NotificationActiveIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Thông báo'
        className='_ab6-'
        color='rgb(38, 38, 38)'
...
export const CreateActiveIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Bài viết mới'
        className='_ab6-'
        color='rgb(38, 38, 38)'
...
export const ViewMoreIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Cài đặt'
        className='_ab6-'
        color='rgb(38, 38, 38)'
...
export const MoreOptionIcon = ({ width = '24', height = '24' }) => (
    <svg
...
export const LikeActiveIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Thích'
        className='_ab6-'
        color='rgb(38, 38, 38)'
...
export const CommentActiveIcon = ({ width = '24', height = '24' }) => (
    <svg
...
export const ShareActiveIcon = ({ width = '24', height = '24' }) => (
    <svg
...
export const UploadImageIcon = ({ width = '24', height = '24' }) => (
    <svg
...
export const EmojiIcon = ({ width = '24', height = '24' }) => (
    <svg
...
export const LikedIcon = ({ width = '24', height = '24' }) => (
    <svg
        aria-label='Bỏ thích'
        className='_ab6-'
        color='rgb(255, 48, 64)'
