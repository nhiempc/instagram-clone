...
const PostFooter: React.FunctionComponent<PostFooterProps> = ({ postData }) => {
    ...
    return (
        <div className={`${style.footerWrapper} flex flex-col pt-4 pb-2`}>
            ...
            <div className={`${style.timeAgo} text-[10px] uppercase pb-3 px-4`}>
                Tháng 9 30, 2019
            </div>
            <div className='addComment flex justify-between px-4 pt-4 pb-2'>
                ...
                <div className={`${style.addCmtBtn} text-[14px] font-medium`}>
